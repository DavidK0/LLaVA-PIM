...
import os
import time
from utils import most_common_string, find_min_average_distance_word,find_min_average_distance_word2, read_csv, save_csv
...
header = ["UPC"] + header[1:]
save_csv(csv_path, data=data, header=header)# This script takes one argument:
#  the path to fv_albt_test_11152023
# This script unifies the product descriptions contained in that folders
